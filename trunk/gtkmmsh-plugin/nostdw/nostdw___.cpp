...
int nostdw___::proc__(std::deque<Glib::ustring>* p,char*buf,long siz,char**addr_ret,void*shangji) {
	...
	if(p0=="窗口背景"){
		...
		if(w2){
			...
			pb_=Gdk::Pixbuf::create_from_file((*p)[1],w->get_width(),w->get_height(),false);
