赋予应用目录【主】【锁】以调用‘得目录名’、先调用‘最终文件名’、‘参数0’了。
...
如果‘数目’等于0那么先
	...
	调用‘执行【sqlite4】’、‘设置库’、“INSERT INTO setting__(name_,value_,use_)VALUES('关机','管理员命令poweroff',2)”。
	调用‘执行【sqlite4】’、‘设置库’、“INSERT INTO setting__(name_,value_,use_)VALUES('重启','管理员命令reboot',2)”。
	调用‘执行【sqlite4】’、‘设置库’、“INSERT INTO setting__(name_,value_,use_)VALUES('iptables -L','管理员命令“iptables -L”',2)”。
